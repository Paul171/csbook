 ...
 * RDBMS: Relational Database Management System
   ...
   * Data Type 每個 Column 會定義格式，每家略有不同，以 MySQL 為例：
     ...
     * Time
     * Datetime
   * SQLIte3 參考: https://www.sqlite.org/datatype3.html
 ...
 * Transaction 交易
   ...
   * 當有跨 tables，多個 SQL 必須同時完成才是正確狀態，就必須用上 Transaction
     * e.g 銀行轉帳
 ...
 * 開源
   * SQLite3 (嵌入式)
     ...
     * GUI: https://addons.mozilla.org/en-US/firefox/addon/sqlite-manager/
   * MySQL
     * GUI: http://www.sequelpro.com/
 ...
 * 做營運用途(OLTP)的 schema 通常會達到第三正規化
   * 舉例:  https://support.microsoft.com/en-us/kb/283878/zh-tw
...
|100| taipei|
   ...
   * Primary Key 主鍵 （唯一識別欄位ID）
     ...
     * 如何選擇你的 Primary Key ?
       ...
       * UUID
         * 1. 分散式系統喜歡用 2. 或是當作 token URL 功能
 ...
 * 關聯設計 Associations
   * ER diagram (entity-relationship model) 一種描述關聯的標準圖表 Diagram: http://en.wikip edia.org/wiki/Entity%E2%80%93relationship_model
  * [ERD "Crow's Foot" Relationship Symbols Cheat Sheet](http://www.vivekmchawla.com/erd-crows-foot-relationship-symbols-cheat-sheet/)
   * 1 to 1
     * 比較不常用，通常只是為了節省查詢量，例如把 BLOB 拆開到另一張表
   * 1 to many
